...
<head> 
    ...
    <script>
    	...
    	function goSave() {
			if (!isCon) return;
    		if ($("#pw").val() != '') {	//비밀번호를 입력했을 경우에만 아래 과정을 수행
                ...
                <table class="board_write">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>*휴대폰 번호</th>
                            <td>
                                <input type="text" name="hp" id="hp" value=""  maxlength="15" style="float:left;" value="${vo.hp }">
                            </td>
                        </tr>
                        <tr>
                            <th rowspan="3">*주소</th>
                            <td>
                                <input type="text" name="zipcode" id="zipcode" value=""  maxlength="6" style="float:left;" value="${vo.zipcode}" readonly>
                                <span class="email_check"><a href="javascript:zipcode();"  class="btn bgGray" style="float:left; width:auto; clear:none;">우편번호</a></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="text" name="addr1" id="addr1" value=""  maxlength="15" style="float:left;" value="${vo.addr1 }" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="text" name="addr2" id="addr2" value=""  maxlength="15" style="float:left;" value="${vo.addr2 }">
                            </td>
                        </tr>
                    </tbody>
                </table>
                        <input type="hidden" name="no" value="${vo.no }"/>	<!-- 폼 안에 hidden으로 숨겨서 no를 넣어준다. -->
                </form>
                <!-- //write--->
